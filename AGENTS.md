...
| | Person A | Person B |
|---|---|---|
| Owns | `src/retrieval/`, `index_build.py` | `agent.py`, `src/dialog/`, `src/obs/`, `eval_tools/`, `tests/` |
